...
public final class DialogFactory {
    ...
    public static AlertDialog.Builder createSimpleDialogBuilder(Context context, String title, String message) {
    ...
    public static AlertDialog createExitDialog(final Context context) {
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(context)
                .setTitle(context.getString(R.string.you_will_quit))
